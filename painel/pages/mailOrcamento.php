...
echo " <meta charset='Windows-1252'>";	 
 ...
 if(!$destinatario){
	 echo "<META HTTP-EQUIV='REFRESH' CONTENT='0; URL=orcamentos.php?mailnot=mailnot'>";
	die();
 ...
 * #########################
 */
$assunto = 'Orçamento '.$_GET['id'].' | FAS Manutenção';
...
você está recebendo, em anexo, o Orçamento nº '.$_GET["id"].'<br>
<br>
...
Em caso de dúvidas, por gentileza entre em contato pelo email fernando@fasmanutencao.one <br>
<br>
...
$Mailer->AddAttachment('./arquivos/'.md5("ORC_".$_GET['id']."").'_ORC_'.$_GET['id'].'.html');
...
else
{
	...
	echo "<META HTTP-EQUIV='REFRESH' CONTENT='0; URL=orcamentos.php?sended=sended'>";
	die(); 
?>